...
ExCalibrator(pxWidth, pxHeight, hzRefreshRate, monitor)
{
	...
	m_fileStimulus = "img/whitecross.tga";
...
void myAutoCalibration::eventRender(unsigned int, CEOSData* samples)
{
	...
	case STATE_BADLOAD: // The calibration data load was unsuccessful
		...
		glColor3d(0, 0, 0);
		printCentered(CFontEngine::FONTS_ARIAL_14, 0.0f, -55.0f, false, "Unable to load previous calibration");

		glColor3d(255, 255, 255);
		printCentered(CFontEngine::FONTS_ARIAL_14, 0.0f, -80.0f, false, "Press any key or button to continue");
		break;
